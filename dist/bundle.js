...
(function (App) {
    ...
    })(InsertPosition = App.InsertPosition || (App.InsertPosition = {}));
})(App || (App = {}));
...
(function (App) {
    ...
    App.projectState = ProjectState.createAppState();
})(App || (App = {}));
var App;
(function (App) {
    ...
    function AutoBind(_, // '_' and '_2' give TS a hint that we don't use these arguments
    _2, propDescriptor) {
...
(function (App) {
    ...
    class ProjectsList extends App.Component {
        ...
        dropHandler(event) {
            ...
            const newStatus = this.projectType === 'active' ? App.ProjectStatus.Active : App.ProjectStatus.Finished;
            App.projectState.changeProjectStatus(projectId, newStatus);
            this.element.classList.remove('droppable');
        }
        ...
        renderProjects() {
            ...
            for (const project of this.storedProjects) {
                new App.ProjectListItem(project, 'single-project', projectsList.id, App.InsertPosition.BeforeEnd);
            }
        }
    }
    __decorate([
...
(function (App) {
    ...
    new App.ProjectInput('project-input', 'app', App.InsertPosition.AfterBegin, 'user-input');
    // create an Active projects list and attach it to DOM
    new App.ProjectsList('project-list', 'app', App.InsertPosition.BeforeEnd, 'active');
    // create a Finished projects list and attach it to DOM
    new App.ProjectsList('project-list', 'app', App.InsertPosition.BeforeEnd, 'finished');
})(App || (App = {}));
/// <reference path="base-component.ts"/>
/// <reference path="../model/drag-drop.ts"/>
/// <reference path="../model/project.ts"/>
...
var App;
(function (App) {
    class ProjectListItem extends App.Component {
    ...
    App.ProjectListItem = ProjectListItem;
})(App || (App = {}));
