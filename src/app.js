...
(function (App) {
    ...
    class ProjectsList extends Component {
        ...
        renderProjects() {
            ...
            for (const project of this.storedProjects) {
                const projectListItem = new ProjectListItem(project, 'single-project', projectsList.id, InsertPosition.BeforeEnd);
            }
        }
    }
    __decorate([
    ...
    const projectInput = new ProjectInput('project-input', 'app', InsertPosition.AfterBegin, 'user-input');
    // create an Active projects list and attach it to DOM
    const activeProjectsList = new ProjectsList('project-list', 'app', InsertPosition.BeforeEnd, 'active');
    // create a Finished projects list and attach it to DOM
    const finishedProjectsList = new ProjectsList('project-list', 'app', InsertPosition.BeforeEnd, 'finished');
})(App || (App = {}));
